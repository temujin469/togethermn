...
function Step5() {
  const { previousStep, job, type } = usePostJob()
      ...
      <Box>
        ...
        <div className='space-y-6'>
          ...
          <div>
            ...
            {/* <div className='preview' dangerouslySetInnerHTML={{ __html: job?.description as string | TrustedHTML }}/> */}
          </div>
          <div>
            <Label>
              Хамгийн тохиромжтой нэр дэвшигч</Label>
            <p className='text-gray-500'>{job?.castTalent?.descTypeOfTalent}</p>
          </div>
          {
          ...
          <div className='grid grid-cols-2 gap-5'>
            ...
            <div>
              <Label>
                Огноо</Label>
              <p className='text-gray-500'>{job?.castTalent?.shootDate}</p>
            </div>
            <div>
              <Label>
                Байршил</Label>
            ...
            <div>
              ...
              <p className='text-gray-500'>{job?.castTalent?.requiredDate}</p>
            </div>
          </div>
          <Table>
            <TableBody>
              <TableRow>
                <TableHead className='text-gray-800'>биеийн төрөл</TableHead>
                <TableCell>{job?.castTalent?.bodyType?.join("\n")}</TableCell>
              </TableRow>
              <TableRow>
                <TableHead className='text-gray-800'>Үсний өнгө</TableHead>
                <TableCell>{job?.castTalent?.hairColor}</TableCell>
              </TableRow>
              <TableRow>
                <TableHead className='text-gray-800'>
                  Хамгийн бага өндөр</TableHead>
