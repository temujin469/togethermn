  ...
  return (
    <footer className="text-center bg-primary text-white">
      <div className='my-container'>
        <div className="container mx-auto pt-6 lg:grid grid-cols-12"
          data-aos="fade-left">
          ...
          <div className='col-span-7'>
            <div className="text-start grid lg:grid-cols-4 md:grid-cols-2"
              ...
              <div className="flex flex-col items-center mb-6">
                <h5 className="font-semibold text-white mb-2.5">Бидний тухай</h5>
              ...
              <div className="flex flex-col items-center mb-6">
                <h5 className="font-semibold text-white mb-2.5">Хэрэглэгчдэд</h5>
        ...
        <div className="text-center text-gray-400 p-4 bg-primary text-sm">
          © 2023
          <a className="text-white/60" href="#"> GLOBAL VISION</a>
        </div>
      </div>
    </footer>
  )
